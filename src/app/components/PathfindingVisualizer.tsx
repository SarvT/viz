...
const PathfindingVisualizer: React.FC<PathfindingVisualizerProps> = ({
  ...
  return (
    <div className="flex flex-col items-center">
      ...
      <Button onClick={findPath} disabled={!start || !end}>
        Find Path
      </Button>

      {/* <div className="example-arr bg-black text-white rounded m-2 p-6 shadow-lg text-center">
        You can use this array for example <br />
        0111111110 <br />0100000010 <br /> 0101111010 <br /> 0101001010 <br /> 0001001010 
        <br /> 1111001010 <br />0000001010 <br />0111111010 <br />0100000010 <br />0111111110
      </div> */}
    </div>
  );
};
